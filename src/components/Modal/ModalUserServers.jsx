        ...
        <div className="modal">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <input onChange={onSearch} type="search" name="" id=""
                           className="form-control form-control-sm mb-2 bg-light" placeholder="Search server ..."/>
                ...
                <div className="modal-footer">
                    ...
                    {isLoading ?
                        <button type="button" className="btn btn-primary" disabled><SpinnerBtn/> Сохранить</button> :
                        <button type="button" className="btn btn-primary"
                                onClick={onClickSetServers}>Сохранить</button>}
                </div>
            </div>
        </div>
    )
